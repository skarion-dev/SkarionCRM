...
import { useCompanyPeople } from '../hooks/use-api.js';
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[820px] text-left text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              ...
              {!isLoading && people.length === 0 && <tr><td colSpan={5} className="px-4 py-12 text-center text-slate-400"><BriefcaseBusiness className="mx-auto mb-2" size={24} />No {config.title.toLowerCase()} captured yet.</td></tr>}
              {isLoading && <tr><td colSpan={5} className="px-4 py-12 text-center text-slate-400">Loading...</td></tr>}
            </tbody>
          </table>
        </div>
      </div>
