...
questions that resolve the highest-impact missing information.`;
  ...
  // Tier bumped from 'cheap' to 'fast': this is a ~150-line, 9-category
  // scoring rubric with strict calibration rules — the most reasoning-dense
  // prompt in the repo, and the one most likely to drift off-rubric on a
  // lite-tier model. Every other agent stays on 'cheap' where the task is
  // genuinely simple.
